...
public class Hud implements Disposable{
    ...
    public Hud(SpriteBatch sb) {
        ...
        healthLabelLabel = new Label("HEALTH", new Label.LabelStyle(new BitmapFont(), Color.WHITE));
        ammoLabelLabel = new Label("AMMO", new Label.LabelStyle(new BitmapFont(), Color.WHITE));
        livesLabelLabel = new Label("LIVES", new Label.LabelStyle(new BitmapFont(), Color.WHITE));
        scoreLabelLabel = new Label("SCORE", new Label.LabelStyle(new BitmapFont(), Color.WHITE));
